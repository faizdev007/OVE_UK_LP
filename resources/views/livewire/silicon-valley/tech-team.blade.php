<div class="border-b border-white text-white bg-sv-gradient-bottomtop py-10">
    {{-- Nothing in the world is as soft and yielding as water. --}}
    <div class="p-6 max-w-7xl mx-auto text-center">
        <h2 class="text-center text-white md:text-3xl text-2xl font-bold mb-10">{ Elite Engineers. Transparent Pricing. Global Reach. }</h2>
        <p>Join hundreds of companies building smarter, faster, and leaner with global tech teams.</p>
