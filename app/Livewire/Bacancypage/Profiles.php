...
class Profiles extends Component
{
    ...
    public function mount($lp_data)
    {
        ...
        [
            ...
            ["name"=>"Sofia","profile"=>"BACK-END DEVELOPER","tools"=>"Python, FastAPI, PostgreSQL","info"=>"Focuses on high-performance data-driven backends.","avtar"=>"/assets/developers/Sofia.webp","company_logo"=>"/assets/previous/itv.webp","company"=>"ITV"],
